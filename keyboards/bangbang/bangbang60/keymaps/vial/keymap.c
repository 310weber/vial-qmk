 ...
 */
	[_QW] = LAYOUT( /* QWERTY */
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(_RS), KC_NO,   KC_SPC,            KC_ENT,  KC_BSPC, MO(_LW), KC_RALT, KC_APP,  KC_RCTL
		),
	...
	[_LW] = LAYOUT(	/* [> LOWER <] */
		...
		KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, MO(_RL), KC_NO,   KC_TRNS,          KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
		),

	[_RL] = LAYOUT(	/* [> RAISE <] + [> LOWER <]*/
		RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   RESET,
	...
	[_NP] = LAYOUT(	/* Numpad Layer */
		KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_PSLS, KC_PAST, KC_PMNS, KC_NO,   KC_NO,   KC_TRNS,
		KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_NO,   KC_NO,   KC_NO,
		KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_NO,   KC_TRNS,
		KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PENT, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, TG(_NP), KC_NO,   KC_NO,            KC_ENT,  KC_P0,   KC_NO,   KC_PDOT,   KC_NO,   KC_NO
		),
