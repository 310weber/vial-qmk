...
*/
	[_QW] = LAYOUT( /* QWERTY */
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(_RS), KC_SPC,  KC_NO,            KC_ENT,  KC_BSPC, MO(_LW), KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
		),
	...
	[_LW] = LAYOUT(	/* [> LOWER <] */
		...
		KC_TRNS, KC_TRNS, KC_TRNS, MO(_RL), KC_TRNS, KC_NO,            KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
		),
